        ...
        <div className="max-w-7xl mx-auto text-center">
          <div className="bg-white/10 backdrop-blur-md rounded-3xl p-8 md:p-12 shadow-2xl">
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">
              ...
              <span className="bg-gradient-to-r from-pink-400 to-purple-400 bg-clip-text text-transparent"> AI Magic</span>
            </h1>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Restore Feature */}
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 text-center hover:bg-white/15 transition-all">
              ...
              <p className="text-white/70">Bring old and damaged photos back to life with AI-powered restoration</p>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 text-center hover:bg-white/15 transition-all">
              ...
              <p className="text-white/70">Transform your photos into beautiful anime-style artwork</p>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 text-center hover:bg-white/15 transition-all">
              ...
              <p className="text-white/70">Add futuristic neon effects and cyberpunk aesthetics</p>
            </div>
          </div>
        </div>
      </section>
