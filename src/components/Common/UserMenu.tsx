      ...
      <div className="relative" ref={menuRef}>
        ...
        {isOpen && (
          <div
            ...
            style={{
              background:
                "linear-gradient(135deg, rgba(17, 17, 17, 0.95) 0%, rgba(31, 31, 31, 0.95) 100%)",
              boxShadow:
                "0 20px 40px rgba(0, 0, 0, 0.6), 0 0 60px rgba(255, 255, 255, 0.08), inset 0 1px 0 rgba(255, 255, 255, 0.1)",
          ...
          >
            ...
            <div className="px-5 py-4 border-b border-gray-700/50 relative">
              <div className="relative z-10">
                ...
                {user.email && (
                  <p
                    className="text-gray-400 text-sm mt-1 truncate opacity-80"
                    title={user.email}
                  >
            ...
            <div className="py-3">
              ...
              >
                ...
                <svg
                  className="w-5 h-5 transition-all duration-300 group-hover:scale-110 group-hover:text-white relative z-10"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
              ...
              <div className="border-t border-gray-700/50 mt-3 pt-3 mx-2">
                ...
                >
                  ...
                  <svg
                    className="w-5 h-5 transition-all duration-300 group-hover:scale-110 group-hover:text-red-400 relative z-10"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
                  ...
                  <span className="font-medium relative z-10 group-hover:text-red-400">
                    Sign Out
                  </span>
                </button>
              </div>
