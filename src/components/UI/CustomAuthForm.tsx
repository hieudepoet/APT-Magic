        ...
        {mode === 'confirmSignUp' && (
          <>
            <div className="text-center mb-6">
              ...
              <p className="text-gray-400">We sent a confirmation code to {formData.email}</p>
            </div>
            <div>
              <label className="block text-white font-medium mb-2">Confirmation Code</label>
              <input
                type="text"
        ...
        >
          {loading ? (
            <div className="flex items-center justify-center">
              ...
              {mode === 'signIn' ? 'Signing In...' : mode === 'signUp' ? 'Creating Account...' : 'Confirming...'}
            </div>
          ) : (
